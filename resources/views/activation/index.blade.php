                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center min-vh-100 bg-light">
                        <div class="card d-flex justify-content-center align-items-center">
                            <div class="card-header d-flex flex-column align-items-center">
                                <h3 class="my-3 text-center" style="max-width: 30ch">Mais segurança na ativação do seu
                                    contrato</h3>
                                <p class="text-body-secondary text-center" style="max-width: 50ch">Precisamos de um
                                    documento para validarmos
                                    alguns dados não vai demorar muito</p>
                            </div>
                            <div class="card-body d-flex flex-column align-items-center">
                                <div class="d-flex align-items-center m-3">
                                    <img src="https://cdn-icons-png.flaticon.com/512/12689/12689789.png"
                                        alt="face-scan-icon" width="180" height="180">
                                </div>
                                <div class="my-6">
                                ...
                                <a href="{{ route('activation.faceId', ['linkHash' => $linkHash]) }}"
                                    class="btn btn-primary waves-effect waves-light">
                                    <span class="d-sm-inline-block d-none me-sm-2 align-middle">Continuar</span>
