<html lang="en" class="layout-wide customizer-hide layout-navbar-fixed" dir="ltr" data-skin="default"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-6">Falta pouco para ativar o seu contrato de fiança locatária. Realize o login
                            para assinar o termo de adesão e efetuar o pagamento:</p>

                        <form id="formAuthentication" class="fv-plugins-bootstrap5 fv-plugins-framework mb-4"
                            method="POST" action="{{ route('activation.verify.login') }}">
                            @csrf
