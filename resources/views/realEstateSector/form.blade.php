        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="form-check form-switch mb-0">
                        ...
                        data-bs-original-title="Ativar/Desativar"
                        type="checkbox" id="user-status-switch" name="ativo"
                        {{ $realEstateSector["ativo"] ? "checked" : "" }}>
                    </div>
                    @endif
                </div>
                <hr class="mt-0 pt-0" />
            ...
            <div class="card-body pb-1">
                ...
                <div class="row gy-4 gx-6">
                    <div
                        class="col-md-4 form-control-validation fv-plugins-icon-container"
                    >
                        ...
                        <input
                            ...
                            maxlength="100"
                            value="{{
                                old('razao', $realEstateSector['razao'] ?? '')
                            }}"
                        />
                        <div
                    ...
                    <div
                        class="col-md-4 form-control-validation fv-plugins-icon-container"
                    >
                        <label for="fantasia" class="form-label"
                            >Fantasia</label
                        >
                        <input
                            class="form-control form-control-lg"
                    ...
                    <div class="col-md-4">
                        ...
                        <input
                            ...
                            maxlength="18"
                            value="{{
                                old('creci', $realEstateSector['creci'] ?? '')
                            }}"
                        />
                    </div>
                    <div class="col-md-4">
                        ...
                        <input
                            ...
                            maxlength="18"
                            value="{{
                                old('cnpj', $realEstateSector['cnpj'] ?? '')
                            }}"
                        />
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input
                            ...
                            maxlength="30"
                            value="{{
                                old('numero', $realEstateSector['numero'] ?? '')
                            }}"
                        />
                    </div>
                    <div class="col-md-4">
                        ...
                        <input
                            ...
                            maxlength="100"
                            value="{{
                                old('bairro', $realEstateSector['bairro'] ?? '')
                            }}"
                        />
                    </div>
                    <div class="col-md-4">
                        ...
                        <input
                            ...
                            maxlength="100"
                            value="{{
                                old('cidade', $realEstateSector['cidade'] ?? '')
                            }}"
                        />
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input
                            ...
                            maxlength="100"
                            value="{{
                                old('cargo', $realEstateSector['cargo'] ?? '')
                            }}"
                        />
                    </div>
                    <div class="col-md-4">
                        ...
                        <input
                            ...
                            value="{{
                                old(
                                    'representante',
                                    $realEstateSector['representante'] ?? ''
                                )
                            }}"
                        />
                    </div>
                    <div class="col-md-4">
                        ...
                        <input
                            ...
                            maxlength="150"
                            value="{{
                                old('email', $realEstateSector['email'] ?? '')
                            }}"
                        />
                    </div>
                    <div class="col-md-4">
                        ...
                        <input
                            ...
                            value="{{
                                old(
                                    'tipo_pagamento',
                                    $realEstateSector['tipo_pagamento'] ?? ''
                                )
                            }}"
                        />
                    </div>
                    <div class="col-md-4">
                        <label for="taxa_padrao" class="form-label"
                            >Taxa Padrão</label
                        >
                    ...
                    <div class="col-md-4">
                        <label for="custo_saida" class="form-label"
                            >Custo Saída</label
                        >
                        <div class="input-group input-group-merge">
                    ...
                    <div class="col-md-4">
                        <label for="cobertura_total" class="form-label"
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input
                                ...
                                value="{{
                                    old(
                                        'cobertura_total',
                                        $realEstateSector['cobertura_total'] ??
                                            ''
                                    )
                                }}"
                            />
                    ...
                    <div class="mt-4 pb-4">
                        ...
                        <a
                            href="{{ route('realestatesector.index') }}"
