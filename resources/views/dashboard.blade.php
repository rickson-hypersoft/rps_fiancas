<html lang="en" class="layout-menu-fixed layout-compact" dir="ltr" data-skin="default" data-assets-path="../../assets/" data-template="horizontal-menu-template-no-customizer" data-bs-theme="light"><head>
    <meta charset="utf-8">
  ...
  <body style="--bs-scrollbar-width: 15px;">
    ...
    <div class="layout-wrapper layout-navbar-full layout-horizontal layout-without-menu">
      <div class="layout-container">
        <!-- Navbar -->
        @include('components.menu', ['user' => session('user'), 'company' => session('company')])
        <!-- / Navbar -->
            ...
            <aside id="layout-menu" class="layout-menu-horizontal menu-horizontal menu flex-grow-0">
              <div class="container-xxl d-flex h-100">
                <ul class="menu-inner">
                  ...
                  <li class="menu-item {{ request()->is('empresa*', 'imobiliarias*', 'usuarios*') ? 'active' : '' }}">
