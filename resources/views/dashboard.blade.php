    ...
    <div class="layout-wrapper layout-navbar-full layout-horizontal layout-without-menu">
        <div class="layout-container">
            ...
            @include('components.menu', [
                'user' => session('user'),
                'realEstateSectorOrCompany' => session('realEstateSectorOrCompany'),
            ])
            <!-- / Navbar -->
                        ...
                        <div class="container-xxl d-flex h-100">
                            <ul class="menu-inner">
                                ...
                                @if (session('user')['categoria'] == 'Fianças')
                                    <li
                                        class="menu-item {{ request()->is('adm/empresa*', 'adm/imobiliarias*', 'adm/usuarios*') ? 'active' : '' }}">
                                        ...
                                        <ul class="menu-sub">
                                            <li
                                                class="menu-item {{ request()->routeIs('company.index') ? 'active' : '' }}">
                                                <a href="{{ route('company.index') }}" class="menu-link">
                                                    <div data-i18n="Minha Empresa">Minha Empresa</div>
                                                </a>
                                            </li>
                                            <li
                                                class="menu-item {{ request()->routeIs('realestatesector.index') ? 'active' : '' }}">
                                ...
                                @if (session('user')['categoria'] == 'Imobiliária')
                                    <li class="menu-item {{ request()->is('propostas*') ? 'active' : '' }}">
                                        ...
                                        <ul class="menu-sub">
                                            <li
                                                class="menu-item {{ request()->routeIs('propostal.create') ? 'active' : '' }}">
                                                <a href="{{ route('propostal.create') }}" class="menu-link">
                                                    <div data-i18n="Criar Proposta">Criar Proposta</div>
                                                </a>
                                            </li>
                                            <li
                                                class="menu-item {{ request()->routeIs('propostal.index') ? 'active' : '' }}">
                                    ...
                                    <li class="menu-item {{ request()->is('contratos*') ? 'active' : '' }}">
                                        ...
                                        <ul class="menu-sub">
                                            <li
                                                class="menu-item {{ request()->routeIs('assets.index') ? 'active' : '' }}">
                                            ...
                                            <li class="menu-item">
                                                <a href="{{ route('delinquencies.index') }}" class="menu-link">
