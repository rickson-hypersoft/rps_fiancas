<div id="analise-credito" class="content active fv-plugins-bootstrap5 fv-plugins-framework">
    <div {{$styles['cardStyle']}} class="{{$styles['card']}}" id="card_status_propostal">
        ...
        <div class="col-lg-8 m-0 px-0.5 d-{{$styles['displaySetup']}}">
            <div class="card" style="border: 1px solid green;">
                <div class="card-header pb-1">
                    ...
                    <hr>
                    <small class="text-success fw-bold" style="font-size: 20px;">12x de {{$proposta['valor_parcelado']}}<span id="valor_parcelado"></span></small>
                ...
                <div class="card-body mb-0">
                    ...
                    <div class="col-12">
                        ...
                        <select class="form-select form-select-lg" name="setup" id="setup" aria-label="Default select example">
                            ...
                            <option value="{{$setup['taxa']}}">{{$setup['taxa_formatada']}}</option>
                            @endforeach
                        </select>
...
<script>
    document.getElementById('form-proposta').addEventListener('submit', async function (e) {
        ...
        console.log(valor)
         ...
         const url = `/prospotas/salvar-step2/${valor}`;
        ...
        fetch(url, {
            ...
            .then(data => {
                Swal.fire({
                    ...
                    window.location.href = `/prospotas/step3/${data.data.id}`;
                });
            })
            .catch(error => {
                console.error(error);
