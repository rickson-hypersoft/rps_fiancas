        ...
        <div class="col-lg-8 col-md-12">
            <div class="row g-4">
                ...
                <div class="col-12 p-0">
                    <div
                        class="swiper-container swiper-container-horizontal swiper bg-lighter swiper-card-advance-bg"
                            ...
                            <div class="row gy-3">
                                <div class="col-md-3 col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        >
                                            <i
                                                class="icon-base ti tabler-file-check icon-lg"
                                            ></i>
                                        </div>
                                        <div class="card-info">
                                ...
                                <div class="col-md-3 col-6">
                                    <div class="d-flex align-items-center">
                                        <div
                                            class="badge rounded bg-label-info me-4 p-2"
                                        >
                                            <i
                                                class="icon-base ti tabler-file-info icon-lg"
                                            ></i>
                                        </div>
                                        <div class="card-info">
                                            <h5 class="mb-0">9</h5>
                                ...
                                <div class="col-md-3 col-6">
                                    <div class="d-flex align-items-center">
                                        <div
                                            class="badge rounded bg-label-warning me-4 p-2"
                                        >
                                            <i
                                                class="icon-base ti tabler-file-dots"
                                            ></i>
                                        </div>
                                        <div class="card-info">
                                            <h5 class="mb-0">18</h5>
                                ...
                                <div class="col-md-3 col-6">
                                    <div class="d-flex align-items-center">
                                        <div
                                            class="badge rounded bg-label-danger me-4 p-2"
                                        >
                                            <i
                                                class="icon-base ti tabler-file-x icon-lg"
                                            ></i>
                                        </div>
                                        <div class="card-info">
                            ...
                            <div class="row gy-3">
                                <div class="col-md-3 col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        >
                                            <i
                                                class="icon-base ti tabler-copy-check icon-lg"
                                            ></i>
                                        </div>
                                        <div class="card-info">
                                            <h5 class="mb-0">10</h5>
                                ...
                                <div class="col-md-3 col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        >
                                            <i
                                                class="icon-base ti tabler-copy-plus icon-lg"
                                            ></i>
                                        </div>
                                        <div class="card-info">
                                            <h5 class="mb-0">6</h5>
                                ...
                                <div class="col-md-3 col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        >
                                            <i
                                                class="icon-base ti tabler-copy-minus"
                                            ></i>
                                        </div>
                                        <div class="card-info">
                                            <h5 class="mb-0">3</h5>
                                ...
                                <div class="col-md-3 col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        >
                                            <i
                                                class="icon-base ti tabler-copy-x icon-lg"
                                            ></i>
                                        </div>
                                        <div class="card-info">
                                            <h5 class="mb-0">2</h5>
        ...
        <div class="col-lg-4 col-md-12">
            <div>
                <div class="card mb-2">
                    ...
                    >
                        <div
                            class="input-group input-group-merge form-send-message"
                        >
                            <input
                                type="text"
                            ...
                            />
                            <span
                                class="message-actions input-group-text"
                                id="text-find"
                            >
                                <i
                                    class="icon-base ti tabler-folder-search cursor-pointer"
                                ></i>
                            </span>
                        </div>
                    </div>
                ...
                <div class="card overflow-hidden" style="height: 440px">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        >
                            <i
                                class="icon-base ti tabler-list-details me-3"
                            ></i>
                            Atividades
                        </h5>
                        <div class="dropdown">
                            ...
                            >
                                <i
                                    class="icon-base ti tabler-dots-vertical icon-md text-body-secondary"
                                ></i>
                            </button>
                            <div
                    ...
                    <div class="card-body pb-xxl-0 table-responsive">
                        <ul class="timeline mb-0">
                            ...
                            <li class="timeline-item timeline-item-transparent">
                                <span
                                    class="timeline-point timeline-point-secondary"
                                ></span>
                                <div class="timeline-event">
                                    <div class="timeline-header mb-1">
