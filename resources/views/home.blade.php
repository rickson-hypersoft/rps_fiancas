            ...
            <div class="col-lg-8 col-md-12">
                <div class="row g-4">
                    ...
                    <div class="col-12 p-0">
                        <div class="swiper-container swiper-container-horizontal swiper bg-lighter swiper-card-advance-bg"
                    ...
                    @php
                        ...
                        $propostasMapeadas = collect($propostas)->mapWithKeys(
                            fn($item) => [trim($item['PROPOSTA_STATUS']) => $item['TOTAL']],
                        );

                        $contratosMapeados = collect($contratos)->mapWithKeys(
                            fn($item) => [trim($item['CONTRATO_STATUS']) => $item['TOTAL']],
                        );
                    @endphp
                ...
                <div>
                        ...
                        <form method="GET" action="{{ route('assets.index') }}" id="form-pesquisa">
                            ...
                            <div class="card-body demo-vertical-spacing demo-only-element">
                                <div class="input-group input-group-merge form-send-message">
                                    <input type="text" class="form-control message-input" placeholder="Pesquisar"
                                        name="search" aria-describedby="text-to-speech-addon" />
                    ...
                    <div class="card overflow-hidden" style="height: 424px">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-text-secondary rounded-pill text-body-secondary me-n1 border-0 p-2"
                                        ...
                                        <div class="timeline-event">
                                            <div class="timeline-header mb-1">
                                                ...
                                                <small class="text-body-secondary">
                                                    {{ \Carbon\Carbon::parse($card['data_ultima_atualizacao'] . ' ' . $card['hora_ultima_atualizacao'])->format('m/Y H:i') }}</small>
                                            </div>
