                ...
                <form id="form-proposta" method="POST">
                    <div class="card-body mb-0 pb-0">
                        ...
                        <div class="row mt-5">
                            <div class="col-md-4 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="imovel_cep" id="imovel_cep_dados" class="form-control form-control-lg" value="{{ $proposta['imovel_cep'] }}" disabled />
                            ...
                            <div class="col-md-8 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="imovel_endereco" id="imovel_endereco" class="form-control form-control-lg" value="{{ $proposta['imovel_endereco'] }}" />
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="imovel_bairro" id="imovel_bairro" class="form-control form-control-lg" value="{{ $proposta['imovel_bairro'] }}" />
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="imovel_estado" id="imovel_estado_dados" class="form-control form-control-lg" value="{{ $proposta['imovel_estado'] }}" disabled />
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="imovel_cidade" id="imovel_cidade_dados" class="form-control form-control-lg" value="{{ $proposta['imovel_cidade'] }}" disabled />
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="imovel_numero" id="imovel_numero" class="form-control form-control-lg" value="{{ $proposta['imovel_numero'] }}" />
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="imovel_complemento" id="imovel_complemento" class="form-control form-control-lg" value="{{ $proposta['imovel_complemento'] }}" />
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    <select class="form-select form-select-lg" name="imovel_subtipo" id="imovel_subtipo" aria-label="Default select example">
                                        <option value="">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="imovel_tag" id="imovel_tag" class="form-control form-control-lg" value="{{ $proposta['imovel_tag'] }}" />
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="pessoa_nome" id="pessoa_nome_dados" class="form-control form-control-lg" value="{{ $proposta['pessoa_nome'] }}" disabled />
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="pessoa_doc" id="pessoa_doc_dados" class="form-control form-control-lg" value="{{ $proposta['pessoa_doc'] }}" disabled />
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    @endphp
                                    <input type="date" name="data_nascimento" id="data_nascimento" class="form-control form-control-lg" value="{{ $dataNascimento ?? '' }}" autocomplete="off" />
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="pessoa_email" id="pessoa_email" class="form-control form-control-lg" value="{{ $proposta['pessoa_email'] }}" />
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="pessoa_telefone" id="pessoa_telefone" class="form-control form-control-lg" value="{{ $proposta['pessoa_telefone'] }}" />
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    <select class="form-select form-select-lg" name="imovel_ramo_atv" id="imovel_ramo_atv" aria-label="Default select example">
                        ...
                        <div class="col-12 d-flex justify-content-between mb-5 mt-5">
                            <a href="{{ route('propostal.step2', ['id' => $proposta['id']]) }}" class="btn btn-label-secondary btn-prev waves-effect">
                                <i class="icon-base ti tabler-arrow-left icon-xs me-sm-2 me-0"></i>
                                <span class="align-middle d-sm-inline-block d-none">Voltar</span>
                            </a>
                            <button id="btn-dados" type="submit" class="btn btn-primary btn-next-dados waves-effect waves-light">
