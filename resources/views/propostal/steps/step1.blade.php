                            ...
                            <div class="col-md mb-md-0 mb-3">
                                <div class="form-check custom-option custom-option-basic">
                                    <label class="form-check-label custom-option-content" for="pessoa_fisica">
                                        <input name="pessoa_tipo" class="form-check-input" type="radio" value="PF" id="pessoa_fisica" {{ ($proposta['pessoa_tipo'] ?? 'Pessoa Física' )==='Pessoa Física' ? 'checked' : '' }}>
                            ...
                            <div class="col-md mb-md-0 mb-3">
                                <div class="form-check custom-option custom-option-basic">
                                    <label class="form-check-label custom-option-content" for="pessoa_juridica">
                                        <input name="pessoa_tipo" class="form-check-input" type="radio" value="PJ" id="pessoa_juridica" {{ ($proposta['pessoa_tipo'] ?? '' )==='Pessoa Jurídica' ? 'checked' : '' }}>
                                        <span class="custom-option-header p-0">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="pessoa_doc" id="pessoa_doc" class="form-control form-control-lg" value="{{ $proposta['pessoa_doc'] ?? '' }}">
                            ...
                            <div class="col-md-8 mb-2">
                                <div class="form-control-validation fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="pessoa_nome" id="pessoa_nome" class="form-control form-control-lg" value="{{ $proposta['pessoa_nome'] ?? '' }}">
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-md-0 mb-5">
                                <div class="form-check custom-option custom-option-basic">
                                    <label class="form-check-label custom-option-content" for="residencial">
                                        <input name="imovel_tipo" class="form-check-input" type="radio" value="R" id="residencial" {{ ($proposta['imovel_tipo'] ?? 'Residencial' )==='Residencial' ? 'checked' : '' }}>
                                        <span class="custom-option-header p-0">
                            ...
                            <div class="col-md-6 mb-md-0 mb-5">
                                <div class="form-check custom-option custom-option-basic">
                                    <label class="form-check-label custom-option-content" for="comercial">
                                        <input name="imovel_tipo" class="form-check-input" type="radio" value="C" id="comercial" {{ ($proposta['imovel_tipo'] ?? '' )==='Comercial' ? 'checked' : '' }}>
                                        <span class="custom-option-header p-0">
                            ...
                            <div class="row mt-5 mb-4 align-items-center">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="imovel_cep" id="imovel_cep" class="form-control form-control-lg" value="{{ $proposta['imovel_cep'] ?? '' }}">
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    </div>
                                </div>
                                <div class="col-md-4" id="estado-container" style="display: none;">
                                    <label class="form-label" for="imovel_estado">Estado</label>
                                    <input type="text" name="imovel_estado" id="imovel_estado" class="form-control form-control-lg" value="{{ $proposta['imovel_estado'] ?? '' }}" readonly>
                                </div>

                                <div class="col-md-4" id="cidade-container" style="display: none;">
                                    <label class="form-label" for="imovel_cidade">Cidade</label>
                                    <input type="text" name="imovel_cidade" id="imovel_cidade" class="form-control form-control-lg" value="{{ $proposta['imovel_cidade'] ?? '' }}" readonly>
                        ...
                        <div class="row">
                            <div class="col-sm-4 mb-4 form-control-validation fv-plugins-icon-container">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input name="imovel_aluguel" style="text-align: right" id='imovel_aluguel' type="text" class="form-control form-control-lg" value="{{ $proposta['imovel_aluguel'] ?? '' }}" aria-label="Amount (to the nearest dollar)">
                                </div>
                            </div>
                            <div class="col-sm-4 mb-4 form-control-validation fv-plugins-icon-container">
                                ...
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text">R$</span>
                                    <input style="text-align: right" name="imovel_condominio" id="imovel_condominio" type="text" class="form-control form-control-lg" value="{{ $proposta['imovel_condominio'] ?? '' }}" aria-label="Amount (to the nearest dollar)">
                                </div>
                            </div>
                            <div class="col-sm-4 mb-4 form-control-validation fv-plugins-icon-container">
                                ...
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text">R$</span>
                                    <input name="imovel_taxas" style="text-align: right" id="imovel_taxas" type="text" class="form-control form-control-lg" value="{{ $proposta['imovel_taxas'] ?? '' }}" aria-label="Amount (to the nearest dollar)">
                                </div>
                            </div>
