    ...
    <div id="wizard-validation" class="bs-stepper mt-2 linear">
        ...
        <div class="bs-stepper-header">
            ...
            <div class="step {{ $currentIndex >= 0 ? 'active' : '' }}" data-target="#criar-proposta">
                <button type="button" class="step-trigger" aria-selected="{{ $currentIndex == 0 ? 'true' : 'false' }}" {{ $currentIndex>= 0 ? '' : 'disabled' }}>
            ...
            <div class="step {{ $currentIndex >= 1 ? 'active' : '' }}" data-target="#analise-credito">
                <button type="button" class="step-trigger" aria-selected="{{ $currentIndex == 1 ? 'true' : 'false' }}" {{ $currentIndex>= 1 ? '' : 'disabled' }}>
            ...
            <div class="step {{ $currentIndex >= 2 ? 'active' : '' }}" data-target="#dados-complementares">
                <button type="button" class="step-trigger" aria-selected="{{ $currentIndex == 2 ? 'true' : 'false' }}" {{ $currentIndex>= 2 ? '' : 'disabled' }}>
            ...
            <div class="step {{ $currentIndex >= 3 ? 'active' : '' }}" data-target="#resumo">
                <button type="button" class="step-trigger" aria-selected="{{ $currentIndex == 3 ? 'true' : 'false' }}" {{ $currentIndex>= 3 ? '' : 'disabled' }}>
            ...
            <div class="step {{ $currentIndex >= 4 ? 'active' : '' }}" data-target="#proposta-enviada">
                <button type="button" class="step-trigger" aria-selected="{{ $currentIndex == 4 ? 'true' : 'false' }}" {{ $currentIndex>= 4 ? '' : 'disabled' }}>
