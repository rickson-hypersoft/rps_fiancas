                ...
                <div class="card-body">
                    <div class="row" id="cards-container" data-card>
                        ...
                        <div class="mt-4" style="display: none" id="selecionar_mais_boletos">
                            <label class="mb-2 block text-sm font-medium text-gray-900">Selecione quais contas estão no
                                mesmo
                                boleto</label>
                        ...
                        <div class="col-4 seguro-field" style="display: none">
                            <label for="vencimento_original_seguro" class="form-label">Vencimento original*</label>
