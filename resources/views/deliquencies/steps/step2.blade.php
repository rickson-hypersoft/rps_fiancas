            ...
            <div class="content-header mb-4">
                ...
                <div class="card-body">
                    <form id="form-proposta"
                        action="{{ route('delinquencies.storeStep2', ['contrato_id' => $contrato_id, 'id' => $idInadimplencia]) }}"
                        ...
                        <div class="row" id="cards-container" data-card>
                            ...
                            <div class="col-4 condominio-field" style="display: none">
                                ...
                                <input required type="date" class="form-control"
                                    id="vencimento_original_condominio" name="vencimento_original_condominio"
                                    aria-describedby="defaultFormControlHelp" />
                            </div>
                            ...
                            <div class="card card-body mb-4 border shadow-sm" data-card>
                                            ...
                                            <div class="form-check custom-option custom-option-basic">
                                                <label class="form-check-label custom-option-content"
                                                    ...
                                                    <input name="customRadioTemp" class="form-check-input"
                                                        type="radio" value="sim" id="customRadioTemp1"
                                                        checked="" />
                                                    <span class="custom-option-header">
                                                        <span class="h6 mb-0">Sim</span>
                                                    </span>
                                        ...
                                        <div class="col-md">
                                            <div class="form-check custom-option custom-option-basic">
                                                <label class="form-check-label custom-option-content"
                                                    for="customRadioTemp2">
                                                    <input name="customRadioTemp" class="form-check-input"
                                                        type="radio" value="não" id="customRadioTemp2" />
                                                    <span class="custom-option-header">
                                                        <span class="h6 mb-0">Não</span>
                                                    </span>
                                                    <span class="custom-option-body">
                                ...
                                <div class="col-4 seguro-field" style="display: none">
                                    <label for="vencimento_original_seguro" class="form-label">Vencimento
                                        original*</label>
                                    <input required type="date" class="form-control"
                                        id="vencimento_original_seguro" aria-describedby="defaultFormControlHelp" />
                                </div>
                                ...
                                <div class="col-4 orcamento-field" style="display: none">
                                    <label for="valor_original_orcamentos" class="form-label">Valor*</label>
                                    <input required type="text" class="form-control"
                                        id="valor_original_orcamentos" placeholder="R$ 0,00"
                                        aria-describedby="defaultFormControlHelp" />
                                </div>
