            ...
            <form action="{{ route('delinquencies.store') }}" method="POST" class="needs-validation" novalidate>
                ...
                <div id="account-details" class="content active dstepper-block">
                    <div class="content-header mb-4 bg-light p-3" style="border-radius: 0.5rem">
                    ...
                    <div class="row g-6">
                                    ...
                                    <div class="col-md">
                                        <div class="form-check custom-option custom-option-basic">
                                            <label class="form-check-label custom-option-content" for="customRadioTemp2">
                                                ...
                                                <span class="custom-option-body">
                                                    <small>O inquilino já saiu do imóvel porém ainda tem débitos com a imobiliária</small>
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12 d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary btn-next waves-effect waves-light">
                                <span class="align-middle d-sm-inline-block d-none me-sm-2">Próximo</span>
