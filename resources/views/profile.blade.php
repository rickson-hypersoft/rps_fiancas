        ...
        <div class="card-body pb-0">
            ...
            @endif
                ...
                <div class="d-flex align-items-start align-items-sm-center gap-6">
                    ...
                    <img src="{{ $profileImage }}" alt="user-avatar" class="d-block w-px-100 h-px-100 rounded" id="uploadedAvatar" />
                    ...
                    <div class="button-wrapper">
                        ...
                        <input type="file" id="upload" name="imagem" class="account-file-input" hidden accept="image/png, image/jpeg" />
        ...
        <div class="card-body">
            <div class="row gy-4 gx-6">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control form-control-lg" type="text" id="email" name="email" value="{{$user['email']}}" placeholder="john.doe@example.com" />
                </div>

                <div class="col-md-6">
                    <label for="nome" class="form-label">Nome</label>
                    <input type="text" class="form-control form-control-lg" id="nome" name="nome" value="{{$user['nome']}}" />
                </div>

                <div class="col-md-6">
                    <label class="form-label" for="cpf">CPF</label>
                    <input type="text" class="form-control form-control-lg" id="cpf" name="cpf" value="{{$user['cpf']}}" />
                </div>

                <div class="col-md-6">
                    <label for="telefone" class="form-label">Telefone</label>
                    <input type="text" class="form-control form-control-lg" id="telefone" name="telefone" value="{{$user['telefone']}}" />
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" id="user-status-switch" name="ativo" {{ $user['ativo'] ? 'checked' : '' }}>
                    </div>
                </div>
