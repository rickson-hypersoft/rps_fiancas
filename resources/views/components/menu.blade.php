            ...
            <ul class="navbar-nav flex-row align-items-center ms-md-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item mt-0" href="{{route('my-profile')}}">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <small class="text-body-secondary d-block">{{$realEstateSectorOrCompany['fantasia']}}</small>
                                    </div>
                                </div>
                            </a>
                        </li>
                        ...
                        $idImobiliaria ? [
                        'route' => route('realestatesector.realestatesectors.index', $idImobiliaria),
                        'icon' => 'tabler-file',
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ $link['route'] }}">
                                <i class="icon-base ti {{ $link['icon'] }} me-3 icon-md"></i>
