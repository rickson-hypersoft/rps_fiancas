...
>
    <div class="container-xxl">
        ...
        >
            ...
            >
                <i
                    class="icon-base ti tabler-x icon-sm d-flex align-items-center justify-content-center"
                ></i>
            </a>
        </div>
            ...
            <ul class="navbar-nav flex-row align-items-center ms-md-auto">
                ...
                <li class="nav-item">
                    ...
                    >
                        <i
                            id="theme-icon"
                            class="tabler-sun icon-base ti icon-22px text-heading"
                        ></i>
                    </button>
                </li>
                <!-- / Style Switcher-->
                ...
                >
                    ...
                    >
                        <span class="position-relative">
                            <i
                                class="icon-base ti tabler-bell icon-22px text-heading"
                            ></i>
                            <span
                            ...
                            >
                                ...
                                <div class="d-flex align-items-center h6 mb-0">
                                    ...
                                    <a
                                        ...
                                        ><i
                                            class="icon-base ti tabler-mail-opened text-heading"
                                        ></i
                                    ></a>
                                </div>
                            </div>
                                        ...
                                        <div class="flex-shrink-0 me-3">
                                            <div class="avatar">
                                                <span
                                                    ...
                                                    ><i
                                                        class="icon-base ti tabler-shopping-cart"
                                                    ></i
                                                ></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-shrink-0 me-3">
                                            <div class="avatar">
                                                <span
                                                    class="avatar-initial rounded-circle bg-label-success"
                                                    ><i
                                                        class="icon-base ti tabler-chart-pie"
                                                    ></i
                                                ></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-shrink-0 me-3">
                                            <div class="avatar">
                                                <span
                                                    ...
                                                    ><i
                                                        class="icon-base ti tabler-alert-triangle"
                                                    ></i
                                                ></span>
                                            </div>
                                        </div>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                            ...
                            >
                                <i
                                    class="icon-base ti tabler-user-circle me-3 icon-md"
                                ></i
                        ...
                        <li>
                            <div class="d-grid px-2 pt-2 pb-1">
                                ...
                                >
                                    <i
                                        class="icon-base ti tabler-logout me-3 icon-md"
                                    ></i
