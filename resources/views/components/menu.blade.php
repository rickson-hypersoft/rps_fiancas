                                ...
                                <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="d-block text-body mb-1">Won the monthly best seller
                                                gold badge</small>
                                ...
                                <li
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="d-block text-body mb-1">You have new message from
                                                Natalie</small>
                                            <small class="text-body-secondary">1h ago</small>
                                        </div>
                                        <div class="dropdown-notifications-actions flex-shrink-0">
                                ...
                                <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="d-block text-body mb-1">ACME Inc. made new order
                                                $1,154</small>
                                ...
                                <li
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="d-block text-body mb-1">Your ABC project application
                                ...
                                <li
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="d-block text-body mb-1">July monthly financial report
                                                is generated
                                            </small>
                                ...
                                <li
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="d-block text-body mb-1">Peter sent you connection
                                                request</small>
                                ...
                                <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="d-block text-body mb-1">Your have new message from
                                                Jane</small>
                                ...
                                <li
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="d-block text-body mb-1">CPU Utilization Percent is
