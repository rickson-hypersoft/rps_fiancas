                    ...
                    <tr>
                        <td>
                            <table width="100%" style="padding:0px 40px; margin-top:32px;">
                                <tr>
                                    <td>
                                        ...
                                        <p style="font-weight:700;color:#697077;">Falta pouco para você pegar as chaves
                                            do seu novo imóvel</p>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p> É muito bom ter você conosco.
                                            ...
                                            Seu cadastro foi aprovado e agora faltam apenas alguns passos para finalizar
                                            seu cadastro.</p>
                                        <p>Para continuar a alugar o seu imóvel de forma rápida e sem burocracia, siga
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                style="padding: 0px 40px;margin-top: 32px;">
                                <tr>
                                        ...
                                        <table cellpadding="0" cellspacing="0" role="presentation">
                                            <tr>
                                                <td style="vertical-align: top; padding-right: 10px;">
                                                    <div
                                                        style="width:24px; height:24px; border:1px solid #191f23; border-radius:50%; text-align:center; line-height:24px; font-size:14px;">
                                                        1
                                                    </div>
                                                </td>
                                    ...
                                    <td style="padding-bottom: 20px;">
                                        <table cellpadding="0" cellspacing="0" role="presentation">
                                            <tr>
                                                ...
                                                <td style="font-family: sans-serif; font-size:14px; color:#191f23;">
                                                    Realize sua biometria facial para acessar os termos de serviço e
                                                    aceitá-los;
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a style="color:#fff;background-color:#7367f0;padding:10px 20px;font-size:12px;border-radius:5px;text-decoration:none;display:inline-block;"
                                            href="{{ route('activation.index', ['linkHash' => $link]) }}">
