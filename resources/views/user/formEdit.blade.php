                    ...
                    -->
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select form-select-lg" id="categoria" name="categoria"
                                ...
                                <option {{ ($user['categoria'] ?? '') == 'Fianças' ? 'selected' : '' }} value="Fianças">
                                    Fianças</option>
                                <option {{ ($user['categoria'] ?? '') == 'Imobiliária' ? 'selected' : '' }}
                                    value="Imobiliária">Imobiliária</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-3" id="editar-empresa-wrapper">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="permissoes[]" id="editar-empresa"
                                    {{ in_array('1', $permissoesArray) ? 'checked' : '' }} value="1">
                        ...
                        <div class="col-md-3" id="cadastro-imobiliarias-wrapper">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="permissoes[]"
                                    id="cadastro-imobiliarias" {{ in_array('2', $permissoesArray) ? 'checked' : '' }}
                                    value="2">
                        ...
                        <div class="col-md-3" id="cadastro-usuarios-wrapper">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="permissoes[]"
                                    id="cadastro-usuarios" {{ in_array('3', $permissoesArray) ? 'checked' : '' }}
                                    value="3">
                        ...
                        <div class="col-md-3">
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" name="permissoes[]"
                                    id="financeiro-alterar" {{ in_array('5', $permissoesArray) ? 'checked' : '' }}
                                    value="5">
