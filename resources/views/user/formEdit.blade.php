            ...
            <form action="{{route('user.update', $user['id'])}}" method="POST" class="fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="form-check form-switch mb-0">
                        <input class="form-check-input" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Ativar/Desativar" type="checkbox" id="user-status-switch" name="ativo" {{ $user['ativo'] ? 'checked' : '' }}>
                    </div>
                </div>
                <hr class="mt-0 pt-0">
        </div>
        <div class="card-body pb-1">
            ...
            <div class="row gy-4 gx-6">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control form-control-lg" type="text" id="email" name="email" maxlength="150" value="{{ old('email', $user['email'] ?? '') }}">
                </div>
                <div class="col-md-4">
                    <label for="cpf" class="form-label">CPF</label>
                    <input class="form-control form-control-lg" type="text" id="cpf" name="cpf" maxlength="18" value="{{ old('cpf', $user['cpf'] ?? '') }}">
                </div>
                <div class="col-md-4">
                    <label for="telefone" class="form-label">Telefone</label>
                    <input type="text" class="form-control form-control-lg" id="telefone" name="telefone" maxlength="16" value="{{ old('telefone', $user['telefone'] ?? '') }}">
                </div>
                <div class="col-md-4">
