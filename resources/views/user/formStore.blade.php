            ...
            <form action="{{route('user.store')}}" method="POST" class="fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                ...
                <div class="row gy-4 gx-6 mb-6">
                    <div class="col-md-4 form-control-validation fv-plugins-icon-container">
                        ...
                        <input value="{{ old('usuario') }}" class="form-control" type="text" id="usuario" name="usuario" maxlength="30">
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                    </div>
                    <div class="col-md-4 form-control-validation fv-plugins-icon-container">
                        <label for="senha" class="form-label">Senha</label>
                        <input value="{{ old('senha') }}" class="form-control" maxlength="255" type="text" id="senha" name="senha" maxlength="100">
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                    </div>
                    <div class="col-md-4 form-control-validation fv-plugins-icon-container">
                        <label for="nome" class="form-label">Nome</label>
                        <input value="{{ old('nome') }}" class="form-control" type="text" name="nome" maxlength="50" id="nome">
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                    </div>
                    <div class="col-md-4">
                        <label for="email" class="form-label">E-mail</label>
                        <input value="{{ old('email') }}" class="form-control" type="text" id="email" name="email" maxlength="150">
                    </div>
                    <div class="col-md-4">
                        <label for="cpf" class="form-label">CPF</label>
                        <input value="{{ old('cpf') }}" class="form-control" type="text" id="cpf" name="cpf" maxlength="18">
                    </div>
                    <div class="col-md-4">
                        <label for="telefone" class="form-label">Telefone</label>
                        <input value="{{ old('telefone') }}" type="text" class="form-control" id="telefone" name="telefone" maxlength="16">
                    </div>
                    <div class="col-md-4">
