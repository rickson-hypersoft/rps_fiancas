    ...
    <div class="col-md-12">
        <div class="card mb-6">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('user.store') }}" method="POST" class="fv-plugins-bootstrap5 fv-plugins-framework"
                    novalidate="novalidate">
                    @csrf
                    <div class="row gy-4 gx-6 mb-6">
                        <div class="col-md-4 form-control-validation fv-plugins-icon-container">
                            <label for="usuario" class="form-label">Usuário</label>
                            <input value="{{ old('usuario') }}" class="form-control form-control-lg" type="text"
                                id="usuario" name="usuario" maxlength="30">
                            <div
                        ...
                        <div class="col-md-4 form-control-validation fv-plugins-icon-container">
                            ...
                            <input value="{{ old('senha') }}" class="form-control form-control-lg" maxlength="255"
                                type="text" id="senha" name="senha" maxlength="100">
                            <div
                                class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            </div>
                        </div>
                        <div class="col-md-4 form-control-validation fv-plugins-icon-container">
                            ...
                            <input value="{{ old('nome') }}" class="form-control form-control-lg" type="text"
                                name="nome" maxlength="50" id="nome">
                            <div
                                class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <input value="{{ old('email') }}" class="form-control form-control-lg" type="text"
                                id="email" name="email" maxlength="150">
                        </div>
                        <div class="col-md-4">
                            <label for="cpf" class="form-label">CPF</label>
                            <input value="{{ old('cpf') }}" class="form-control form-control-lg" type="text"
                                id="cpf" name="cpf" maxlength="18">
                        </div>
                        <div class="col-md-4">
                            <label for="telefone" class="form-label">Telefone</label>
                            <input value="{{ old('telefone') }}" type="text" class="form-control form-control-lg"
                                id="telefone" name="telefone" maxlength="16">
                        </div>
                        <div class="col-md-4">
                            ...
                            <select class="form-select form-select-lg" name="nivel" id="nivel"
                                ...
                                <option value="Administrador" {{ old('nivel') == 'Administrador' ? 'selected' : '' }}>
                                    Administrador</option>
                                <option value="Corretor" {{ old('nivel') == 'Corretor' ? 'selected' : '' }}>Corretor
                                </option>
                                <option value="Financeiro" {{ old('nivel') == 'Financeiro' ? 'selected' : '' }}>Financeiro
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select form-select-lg" id="categoria" name="categoria"
                                ...
                                <option value="Fianças" {{ old('categoria') == 'Fianças' ? 'selected' : '' }}>Fianças
                                </option>
                                <option value="Imobiliária" {{ old('categoria') == 'Imobiliária' ? 'selected' : '' }}>
                                    Imobiliária</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-3" id="editar-empresa-wrapper">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="editar-empresa" name="permissoes[]"
                                    checked value="1">
                        ...
                        <div class="col-md-3" id="cadastro-imobiliarias-wrapper">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="cadastro-imobiliarias"
                                    name="permissoes[]" checked value="2">
                                <label class="form-check-label" for="cadastro-imobiliarias">Cadastro de
                                    Imobiliárias</label>
                            </div>
                        </div>
                        <div class="col-md-3" id="cadastro-usuarios-wrapper">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="cadastro-usuarios"
                                    name="permissoes[]" checked value="3">
                                <label class="form-check-label" for="cadastro-usuarios">Cadastro de Usuários</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" id="financeiro-adicionar"
                                    name="permissoes[]" checked value="4">
                                <label class="form-check-label" for="financeiro-adicionar">Financeiro Adicionar</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" id="financeiro-alterar"
                                    name="permissoes[]" checked value="5">
                                <label class="form-check-label" for="financeiro-alterar">Financeiro Alterar</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" id="financeiro-excluir"
                                    name="permissoes[]" checked value="6">
                                <label class="form-check-label" for="financeiro-excluir">Financeiro Excluir</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" id="aceitar-termos" name="permissoes[]"
                                    checked value="7">
                        ...
                        <div class="col-md-3">
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" id="acesso-comissoes"
                                    name="permissoes[]" checked value="8">
                                <label class="form-check-label" for="acesso-comissoes">Acesso a Comissões</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" id="acesso-renovacoes"
                                    name="permissoes[]" checked value="9">
                                <label class="form-check-label" for="acesso-renovacoes">Acesso a Renovações</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" id="acesso-simulador"
                                    name="permissoes[]" checked value="10">
                                <label class="form-check-label" for="acesso-simulador">Acesso ao simulador</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" id="criar-proposta" name="permissoes[]"
                                    checked value="11">
                        ...
                        <div class="col-md-3">
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" id="contratos" name="permissoes[]"
                                    checked value="12">
                        ...
                        <div class="col-md-3">
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" id="notificacao-movimento-cobranca"
                                    name="permissoes[]" checked value="13">
                        ...
                        <div class="col-md-3">
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" id="notificacao-movimentacao-contrato"
                                    name="permissoes[]" checked value="14">
                        ...
                        <div class="col-md-3">
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" id="notificacao-movimentacao-padrao"
                                    name="permissoes[]" checked value="15">
                        ...
                        <div class="col-md-3">
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" id="notificacao-movimentacao-exoneracao"
                                    name="permissoes[]" checked value="16">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function loadImobiliarias() {
                ...
                try {
                    ...
                    if (data.length === 0) {
                        imobiliariaSelect.innerHTML =
                        '<option value="">Nenhuma imobiliária encontrada</option>';
                        return;
                    }
