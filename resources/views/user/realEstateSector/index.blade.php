            ...
            <div class="card mb-0">
                <div class="card-header">
                        ...
                        <div class="col-sm-7 col-12 mb-1">
                            <form action="{{route('realestatesector.users.index')}}" method="GET">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" placeholder="Pesquisar pelo nome ou CPF" id="pesquisar" name="search" value="{{ request('search') }}" aria-label="Pesquisar pelo nome ou CPF" aria-describedby="button-addon2">
                    ...
                    <div class="col-sm-5 mt-4" style="text-align: right">
                        <a href="{{route('realestatesector.users.create')}}" class="btn btn-lg btn-primary waves-effect waves-light">Adicionar Usuário</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
