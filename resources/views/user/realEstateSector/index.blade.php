        ...
        <div class="col-12">
            <div class="card mb-0">
                <div class="card-header">
                    ...
                    <div class="row align-items-center pt-5">
                        <div class="col-sm-7 col-12 mb-1">
                            <form
                                action="{{
                                    route('realestatesector.users.index')
                                }}"
                                method="GET"
                            >
                                <label for="pesquisar" class="form-label"
                                    >Pesquisar</label
                                >
                                <div class="input-group">
                                    <input
                                        ...
                                        aria-label="Pesquisar pelo nome ou CPF"
                                    ...
                                    >
                                        <i
                                            class="icon-base ti tabler-search"
                                        ></i>
                                    </button>
                                </div>
                            </form>
                        ...
                        <div class="col-sm-5" style="text-align: right">
                            <a
                                href="{{
                                    route('realestatesector.users.create')
                                }}"
                ...
                <div class="card-body">
                    <div class="table table-responsive" style="height: 250px">
                        ...
                        >
                            ...
                            <tbody id="ViewNiveisLTableItens">
                                @foreach ($users as $user) @php $path =
                                public_path('assets/user-profiles/' .
                                $user['id'] . '.png'); $image =
                                file_exists($path) ?
                                asset('assets/user-profiles/' . $user['id'] .
                                '.png') :
                    ...
                    @php $firstItem = $pagination['from']; $lastItem =
                    $pagination['to']; $total = $pagination['total'];
                    $currentPage = $pagination['current_page']; $lastPage =
                    $pagination['last_page']; @endphp @if ($total > 0 &&
                    $lastPage > 1)
                    <div class="mt-25 float-end">
                        <div
                            class="d-flex justify-content-between align-items-center mt-3 py-2 px-4"
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination pagination-sm mb-0">
                                    ...
                                    >
                                        ...
                                        >
                                            <i
                                                class="icon-base ti tabler-chevrons-left icon-sm"
                                            ></i>
                                        </a>
                                    </li>
                                    ...
                                    >
                                        ...
                                        >
                                            <i
                                                class="icon-base ti tabler-chevron-left icon-sm"
                                            ></i>
                                        </a>
                                    </li>
                                    ...
                                    >
                                        ...
                                        >
                                            <i
                                                class="icon-base ti tabler-chevron-right icon-sm"
                                            ></i>
                                        </a>
                                    </li>
                                    ...
                                    >
                                        ...
                                        >
                                            <i
                                                class="icon-base ti tabler-chevrons-right icon-sm"
                                            ></i>
                                        </a>
                                    </li>
                                </ul>
