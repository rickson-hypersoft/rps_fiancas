                        ...
                        <div class="col-sm-7 col-12 mb-1">
                            <form action="{{route('user.index')}}" method="GET">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" placeholder="Pesquisar pelo nome, usuário ou CPF" id="pesquisar" name="search" value="{{ request('search') }}" aria-label="Pesquisar pelo nome, usuário ou CPF" aria-describedby="button-addon2">
                                ...
                                <td class="align-middle">
                                    <div class="dropdown" style="text-align: right;">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item waves-effect btn-excluir" href="javascript:void(0);" data-id="{{$user['id']}}" data-route="{{ route('user.delete', ['usuario' => '__id__']) }}">
