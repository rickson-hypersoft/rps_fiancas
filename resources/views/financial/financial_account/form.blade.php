        ...
        <div class="card-header">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="form-check form-switch mb-0">
                        <input class="form-check-input" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Ativar/Desativar" type="checkbox" id="user-status-switch" name="ativo" {{ $financialAccount['ativo'] ? 'checked' : '' }}>
                    </div>
                    @endif
                </div>
                <hr class="mt-0 pt-0">
