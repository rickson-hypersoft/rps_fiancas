                    ...
                    <div class="card-header">
                        ...
                        <div class="row align-items-center pt-5">
                            ...
                            <div class="col-sm-5" style="text-align: right">
                                <a href="{{ route('financial.financial_account.create') }}"
                                    class="btn btn-lg btn-primary waves-effect waves-light">Adicionar Conta</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    @if ($financialAccounts)
                                        @foreach ($financialAccounts as $financialAccount)
                                            <tr>
                                                ...
                                                <td><span
                                                        class="badge bg-label-{{ $financialAccount['ativo'] ? 'success' : 'danger' }} me-1">
                                                    ...
                                                    <div class="dropdown" style="text-align: center;">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item waves-effect"
                                                                href="{{ route('financial.financial_account.edit', $financialAccount['id']) }}"><i
                                                                    class="icon-base ti tabler-pencil me-1"></i> Editar</a>
                                                            <a class="dropdown-item waves-effect btn-excluir"
                                                                href="javascript:void(0);"
                                                                data-id="{{ $financialAccount['id'] }}"
                                                                data-route="{{ route('financial.financial_account.delete', ['financeiro_conta' => '__id__']) }}">
