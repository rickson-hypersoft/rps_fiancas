                        ...
                        <div class="col-sm-7 col-12 mb-1">
                            <form action="{{route('financial.financial_account.index')}}" method="GET">
                                ...
                                <div class="input-group">
                                    <input type="text" id="pesquisar" class="form-control form-control-lg" placeholder="Pesquisar pela descrição" name="search" value="{{request('search')}}" aria-label="Pesquisar pela descrição" aria-describedby="button-addon2">
                ...
                <div class="table table-responsive" style="height: 250px;">
                    <table class="table table-sm table-borderless table-striped table-hover" style="font-size: 18px;">
                        ...
                        <tbody id="ViewNiveisLTableItens">
                                ...
                                <td>
                                    <div class="dropdown" style="text-align: center;">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item waves-effect" href="{{route('financial.financial_account.edit', $financialAccount['id'])}}"><i class="icon-base ti tabler-pencil me-1"></i> Editar</a>
                                            <a class="dropdown-item waves-effect btn-excluir" href="javascript:void(0);" data-id="{{$financialAccount['id']}}" data-route="{{ route('financial.financial_account.delete', ['financeiro_conta' => '__id__']) }}">
                            ...
                            @else
                            <tr>
                                <td class="text-center" colspan="5">Não possui contas cadastradas</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
