                        ...
                        @if ($method === 'PUT')
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                    ...
                                    name="ativo" {{ $financialCategory['ativo'] ? 'checked' : '' }}>
                            </div>
                        @endif
                    </div>
                    <hr class="mt-0 pt-0">
                ...
                <div class="card-body">
                    ...
                    <div class="row gy-4 gx-6">
                        <div class="col-md-4">
                            ...
                            <input value="{{ old('descricao', $financialCategory['descricao'] ?? '') }}" type="text"
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select form-select-lg" name="tipo" id="tipo"
                                ...
                                <option value="C"
                                    {{ old('tipo', $financialCategory['tipo'] ?? '') == 'Crédito' ? 'selected' : '' }}>
                                    Crédito
                                </option>
                                <option value="E"
                                    {{ old('tipo', $financialCategory['tipo'] ?? '') == 'Escolher' ? 'selected' : '' }}>
                                    Escolher
                                </option>
                            </select>
                        </div>
