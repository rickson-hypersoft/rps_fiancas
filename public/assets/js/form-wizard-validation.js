...
(function () {
    ...
    if (typeof wizardValidation !== undefined && wizardValidation !== null) {
        ...
        // Wizard steps
        const wizardValidationFormStep1 = wizardValidationForm.querySelector('#criar-proposta');
        const wizardValidationFormStep2 = wizardValidationForm.querySelector('#analise-credito');
        const wizardValidationFormStep3 = wizardValidationForm.querySelector('#dados-complementares');
        const wizardValidationFormStep4 = wizardValidationForm.querySelector('#resumo');
        const wizardValidationFormStep5 = wizardValidationForm.querySelector('#proposta-enviada');
        ...
        const FormValidation1 = FormValidation.formValidation(wizardValidationFormStep1, {
            fields: {
                pessoa_doc1: {
                    validators: {
                        notEmpty: {
                            message: 'O campo CPF precisa ser preenchido'
                        },
                        stringLength: {
                            min: 6,
                            max: 30,
